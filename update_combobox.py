...
Use a combobox to display valid values for certain fields.
...
class EditableSqlModel(QtSql.QSqlQueryModel):
    ...
    def refresh(self):
        sql = dedent("""\
                SELECT branch.BranchID, branch.BranchName, FromBus.BusKey, ToBus.BusKey
                FROM branch
        ...
        self.setHeaderData(4, Qt.Horizontal, "FromBusID")
        self.setHeaderData(5, Qt.Horizontal, "ToBusID")
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        model.setQuery(sql)
        model.setHeaderData(2, Qt.Horizontal, "BranchID")
        model.setHeaderData(3, Qt.Horizontal, "BranchName")
        model.setHeaderData(4, Qt.Horizontal, "FromBusID")
        model.setHeaderData(5, Qt.Horizontal, "ToBusID")
